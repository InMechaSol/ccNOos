...
ccNOosTestsAppDIR = $${ccNOosDIR}/tests/testApps/ccNOos_Tests
ccNOosTestsPlatformDIR = $${ccNOosDIR}/tests/testPlatforms
ccNOosTestsMainsDIR = $${ccNOosDIR}/tests/testMainFiles/ccNOos_Tests/QtCreatorC
